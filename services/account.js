...
async function createACHRelationship(user, account_object) {
    ...
    const options = {
      method: 'POST',
      url: `https://broker-api.sandbox.alpaca.markets/v1/accounts/${account_object.account_id}/ach_relationships`,
      headers: {
        accept: 'application/json',
        'content-type': 'application/json',
        authorization: 'Basic Q0tJWDJHTUVZVjVCTlNKNFhZRUE6cE5zY1NjU0RWd1B3cm9GYXd3SjJ1aFJGRjdxbEFoemxoV29yaVJWbQ=='
  ...
  async function createBankRelationship(bank_relationship_object) {
    ...
    const options = {
      method: 'POST',
      url: `https://broker-api.sandbox.alpaca.markets/v1/accounts/${bank_relationship_object.account_id}/recipient_banks`,
      headers: {
        accept: 'application/json',
        'content-type': 'application/json',
        authorization: 'Basic Q0tJWDJHTUVZVjVCTlNKNFhZRUE6cE5zY1NjU0RWd1B3cm9GYXd3SjJ1aFJGRjdxbEFoemxoV29yaVJWbQ=='
